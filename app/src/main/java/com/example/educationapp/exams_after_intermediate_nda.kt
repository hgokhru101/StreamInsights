 ...
 * Use the [exams_after_intermediate_nda.newInstance] factory method to
...
class exams_after_intermediate_nda : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment exams_after_intermediate_nda.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            exams_after_intermediate_nda().apply {
