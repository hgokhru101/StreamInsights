    ...
    override fun onCreateView(
        ...
        try{
            ...
            for(i in 0 until after_Intermediate_Model.data[0].streams[2].course.size) {
                degree_name.add(after_Intermediate_Model.data[0].streams[2].course[i].degree_name)
        ...
        view.findViewById<TextView>(R.id.eligibility).text="Eligibility: "+after_Intermediate_Model.data[0].streams[2].eligible
